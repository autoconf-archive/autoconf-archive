...
#   -fomit-frame-pointer option to the shellvar (per default CFLAGS)
#   and remove the " -g " debuginfo option from it. In other words, the
#   default is "--disable-frame-pointer"
#
# LAST MODIFICATION
#
#   2006-10-13
