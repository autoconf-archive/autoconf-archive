...
# DESCRIPTION
#
#   Makes sure that .NET Core supports the version indicated. If true the shell
#   commands in ACTION-IF-TRUE are executed. If not the shell commands in
#   ACTION-IF-FALSE are run. The $dotnetcore_version variable will be filled with
#   the detected version.
#
#   This macro uses the $DOTNETCORE variable to perform the check.
#   If $DOTNETCORE is not set prior to calling this macro, the macro will fail.
#
#   Example:
#
...
#
#   Searches for .NET Core, then checks if at least version 1.0.2 is present.
#
# LICENSE
#
