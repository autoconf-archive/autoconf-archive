...
#   The default version tested for is 4.0.0.
#   
#   The macro tests for ZMQ libraries in the library/include path,
#   and, when provided, also in the path given by --with-zmq.
#
#   This macro calls:
#
