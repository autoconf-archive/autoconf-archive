##### http://autoconf-archive.cryp.to/ac_latex_package_input.html
#
# OBSOLETE MACRO
#
...
# SYNOPSIS
#
#   AC_LATEX_INPUT(<package>,<class>,<variable>)
#
# DESCRIPTION
#
#   This macro test if package in <class> exists and set <variable> to
#   the right value (yes or no) Use \input instance of \usepackage
#
# LAST MODIFICATION
#
#   2006-07-16
