...
# DESCRIPTION
#
#   This macros execute the latex application with FILEDATA as input
#   and set VARIABLETOSET the yes or no depending of the result if
#   NOCLEAN is set, the folder used for the test is not delete after
#   testing.
#
# LAST MODIFICATION
#
