...
# DESCRIPTION
#
#   Try to find a compiler option that makes all string literals
#   readonly.
#
...
#
#   For the GNU CC compiler it will be -fno-writable-strings
#   -Wwrite-strings The result is added to the shellvar being CFLAGS by
#   default.
#
#   DEFAULTS:
#
