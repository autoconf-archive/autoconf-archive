# ===========================================================================
#      http://www.nongnu.org/autoconf-archive/ax_cflags_hpux_option.html
# ===========================================================================
#
# SYNOPSIS
#
...
AS_VAR_PUSHDEF([VAR],[ax_cv_cflags_hpux_option_$2])dnl
...
AS_VAR_PUSHDEF([VAR],[ax_cv_cxxflags_hpux_option_$2])dnl
AC_CACHE_CHECK([m4_ifval($1,$1,FLAGS) for hpux/cc m4_ifval($2,$2,-option)],
VAR,[VAR="no, unknown"
 AC_LANG_SAVE
 AC_LANG_CPLUSPLUS
