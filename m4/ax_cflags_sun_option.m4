...
# DESCRIPTION
#
#   AX_CFLAGS_SUN_OPTION(+xtreme) would show a message as like
#   "checking CFLAGS for sun/cc +xtreme ... yes" and adds the
...
#
#   The cousin AX_CXXFLAGS_SUN_OPTION would check for an option to add
