# ===========================================================================
#     http://www.gnu.org/software/autoconf-archive/ax_cxx_check_flag.html
# ===========================================================================
#
# OBSOLETE MACRO
#
...
m4_ifnblank([$2], [AC_WARNING([PROLOGUE argument ($2) dropped after converting from AX_CXX_CHECK_FLAG to AX_CHECK_COMPILE_FLAG.])
])dnl
m4_ifnblank([$3], [AC_WARNING([BODY argument ($3) dropped after converting from AX_CXX_CHECK_FLAG to AX_CHECK_COMPILE_FLAG.])
])dnl
  AC_REQUIRE([AC_PROG_CXX])
  AC_LANG_PUSH([C++])
  AX_CHECK_COMPILE_FLAG([$1], [$4], [$5])
  AC_LANG_POP
],[You might want to remove some superfluous AC_REQUIRE([AC_PROG_CC]) and AC_LANG_PUSH/POP macros])dnl AX_CXX_CHECK_FLAG
