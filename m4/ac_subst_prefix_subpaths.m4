...
#   "./" (dotslash) is prepended, otherwise it can be seen as an absolute
#   path that can not be moved, which you possibly do for "/etc" files, or
#   even those ending up in "/lib/modules" or "/winnt/system".
#
...
#   PATH_BINDIR PATH_LIBDIR PATH_PKGDATADIR - see posix' include/paths.h
#   that creates _PATH_DEV and friends.
#
# LAST MODIFICATION
#
#   2008-04-12
