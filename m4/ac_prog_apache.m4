...
#   specified when calling configure or just --with-apache, it searches
#   in
...
#     @APACHE@ -d /etc/httpd
#
#   It defines the symbol APACHE_MODULES if a directory containing
#   mod_env.* is found in the default server root directory (obtained
#   with httpd -V).
#
