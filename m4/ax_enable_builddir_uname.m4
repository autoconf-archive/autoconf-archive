...
#   there. We provide an option --disable-builddir to suppress the move
#   into a separate builddir.
#
#   Defaults:
#
...
#     $3 = -all
#
#   This macro must be called before AM_INIT_AUTOMAKE. It creates a
...
#   override the auto-dection through `uname -msr | tr " /" "__"`.d at
#   build-time of course, as in
#
...
#   only ever exist in the srcdir toplevel makefile - these parts are
...
#   the tarball from the builddir to the sourcedir (or $(PUB)) for
