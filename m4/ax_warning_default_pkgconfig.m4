...
#   is generated with pkgconfigdir=${libdir}/pkgconfig
#
...
#   and furthermore a configure option "--enable-default-pkgconfigdir"
#   is provided. Only if that option is set then $2 default is not set
#   to the canonic default in the a $prefix subpath but instead $2
#   default is set to the primary path where `pkg-config` looks for .pc
#   files. The user may also override the default on the command line.
#
# LAST MODIFICATION
#
#   2006-10-13
