# ===========================================================================
#    http://www.nongnu.org/autoconf-archive/ax_prompt_user_no_define.html
# ===========================================================================
#
# OBSOLETE MACRO
#
...
# SYNOPSIS
#
#   AX_PROMPT_USER_NO_DEFINE(VARIABLENAME,QUESTION,[DEFAULT])
#
# DESCRIPTION
#
...
AC_DEFUN([AX_PROMPT_USER_NO_DEFINE],
dnl changequote(<<, >>) dnl
dnl <<
[
