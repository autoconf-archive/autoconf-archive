...
# DESCRIPTION
#
#   Test for the CZMQ libraries of a particular version (or newer).
#   The default version tested for is 3.0.0.
#   
#   The macro tests for CZMQ libraries in the library/include path,
#   and, when provided, also in the path given by --with-czmq.
#
#   This macro calls:
#
