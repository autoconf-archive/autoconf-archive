...
#   the configuration would export the required compiler flags to "GLU_CFLAGS"
#   and "GLU_LIBS" environment variables. These two variables can also be
...
#   when the tests succeeded does the configure script to export "HAVE_GLU=1"
#   and to run "ACTION-IF-FOUND" hook.
#
#   If user didn't specify the "ACTION-IF-FOUND" hook, the configuration would
#   prepend "GLU_CFLAGS" and "GLU_LIBS" to "CFLAGS" and "LIBS", like many other
#   autoconf macros do.
#
