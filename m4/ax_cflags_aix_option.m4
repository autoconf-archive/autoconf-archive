...
AC_DEFUN([AX_CFLAGS_AIX_OPTION_PRIVATE], [dnl
...
AC_DEFUN([AX_CXXFLAGS_AIX_OPTION_PRIVATE], [dnl
...
AC_DEFUN([AX_CFLAGS_AIX_OPTION],[
  AX_CFLAGS_AIX_OPTION_PRIVATE(ifelse(m4_bregexp([$2],[-]),-1,[[$1],[$2]],[[$2],[$1]]),[$3],[$4])
])

AC_DEFUN([AX_CXXFLAGS_AIX_OPTION],[
  AX_CXXFLAGS_AIX_OPTION_PRIVATE(ifelse(m4_bregexp([$2],[-]),-1,[[$1],[$2]],[[$2],[$1]]),[$3],[$4])
])
