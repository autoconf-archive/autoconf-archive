...
# DESCRIPTION
#
#   AX_CFLAGS_AIX_OPTION(-qubicle) would show a message as like
#   "checking CFLAGS for aix/cc -qubicle ... yes" and adds the
...
#
#   The cousin AX_CXXFLAGS_AIX_OPTION would check for an option to add
