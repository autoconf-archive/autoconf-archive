# ===========================================================================
#          http://autoconf-archive.cryp.to/ac_latex_package_opt.html
# ===========================================================================
#
# OBSOLETE MACRO
#
...
# DESCRIPTION
#
#   This macro test if package in <class> with option <option> exists and
#   set <variable> to the right value (yes or no)
#
# LAST MODIFICATION
#
#   2008-04-12
