...
# SYNOPSIS
#
#   AX_PKG_CHECK_MODULES(PREFIX, PUBLIC-MODULES, PRIVATE-MODULES,
...
#   variables are exposed via AC_SUBST, and should be used in a pkg-config file
#   as the substituted values for Requires and Requires.private.
#
#   The PREFIX, PUBLIC-MODULES and PRIVATE-MODULES arguments should be specified
#   as for PKG_CHECK_MODULES, with the concatenation of PUBLIC-MODULES and
#   PRIVATE-MODULES equaling the LIST-OF-MODULES from PKG_CHECK_MODULES.
#
#   PUBLIC-VARIABLE defaults to AX_PACKAGE_REQUIRES, and PRIVATE-VARIABLE
#   defaults to AX_PACKAGE_REQUIRES_PRIVATE.  Both variables are AC_SUBST-ed by
#   this macro.
#
#   For example:
