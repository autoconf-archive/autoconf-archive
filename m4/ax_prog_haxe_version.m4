# ===========================================================================
#   (TDB: pending pull request to autoconf)
# ===========================================================================
#
# SYNOPSIS
#
...
#   ACTION-IF-FALSE are run. The $HAXE_VERSION variable will be filled
#   with the detected version.
#
#   This macro uses the $HAXE variable to perform the check. 
#   If $HAXE is not set prior to calling this macro, the macro will fail.
#
#   Example:
#
