...
# DESCRIPTION
#
#   set the specfile - if no argument has been given then check whether
#   the ac_unique_file looks like a .spec file and use it. This macro
#   is ac_REQUIRED by many AX_SPEC_ routines.
#
#   the AX_SPEC_EXTRACT macro is a helper used by many AX_SPEC_
#   routines and therefore placed here to be automatically included in
#   the macro set of (older) aclocal/acinclude.
#
