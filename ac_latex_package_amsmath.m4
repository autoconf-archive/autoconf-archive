...
# DESCRIPTION
#
#   This macro test if \usepackage{amsmath,amsfonts} works. If yes, it
#   set $amsmath="\usepackage{amsmath,amsfonts}" Else if
#   \usepackage{amstex} works, set $amsmath="\usepackage{amstex}" else
#   ERROR
#
# LAST MODIFICATION
#
