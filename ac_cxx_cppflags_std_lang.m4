...
# DESCRIPTION
#
#   Append to CPP-FLAGS the set of flags that should be passed to the
#   C++ preprocessor in order to enable use of C++ features as defined
#   in the ANSI C++ standard (eg. use of standard iostream classes in
#   the `std' namespace, etc.).
#
# LAST MODIFICATION
#
#   2004-09-07
