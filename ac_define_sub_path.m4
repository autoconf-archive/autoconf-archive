...
#   install-paths that largely depend on either ${prefix} or
#   ${exec_prefix}. Just cut out the prefix and ac_define the value.
#   The value is uppercased and PATH_ prepended ie.
#   ac_define_sub_paths(bindir libdir pkgdatadir) will create the
