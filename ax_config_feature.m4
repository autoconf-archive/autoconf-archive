...
# DESCRIPTION
#
#   AX_CONFIG_FEATURE is a simple wrapper for AC_ARG_ENABLE, it enables
#   the feature FEATURE-NAME and AC_DEFINEs the passed DEFINE,
#   depending on the user choice. DESCRIPTION will be used for
#   AC_DEFINEs. ACTION-IF-ENABLED and ACTION-IF-NOT-ENABLED are the
#   actions that will be run. A feature is enabled by default, in order
#   to change this behaviour use the AX_CONFIG_FEATURE_DEFAULT_ENABLED
#   and AX_CONFIG_FEATURE_DEFAULT_DISABLED macros.
#
#   A simple example:
#
...
#       ...
#
#   If you have lot of features and you want a verbose dumping of each
#   user selection use AX_CONFIG_FEATURE_VERBOSE. Use
#   AX_CONFIG_FEATURE_SILENT in order to remove a previously
#   AX_CONFIG_FEATURE_VERBOSE. By default features are silent.
#
#   Use AX_CONFIG_FEATURE_ENABLE or AX_CONFIG_FEATURE_DISABLE in order
...
#       ...
#
#   NOTE: AX_CONFIG_FEATURE_ENABLE() must be placed first of the
#   relative AX_CONFIG_FEATURE() macro ...
#
# LAST MODIFICATION
#
#   2005-01-22
