...
# DESCRIPTION
#
#   AX_CFLAGS_IRIX_OPTION(-go_for_it) would show a message as like
#   "checking CFLAGS for irix/cc -go_for_it ... yes" and adds the
...
#
#   The cousin AX_CXXFLAGS_IRIX_OPTION would check for an option to add
...
#   option-to-check-for.
#
#   see also: AX_CFLAGS_GCC_OPTION for the widely used original
#   variant.
#
# LAST MODIFICATION
#
