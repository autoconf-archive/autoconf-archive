...
# DESCRIPTION
#
#   If the compiler can be asked to prevent using implicitly one
#   argument constructors as converting constructors with the explicit
#   keyword, define HAVE_EXPLICIT.
#
# LAST MODIFICATION
#
#   2004-02-04
