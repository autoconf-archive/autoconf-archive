...
#   an argument. In many cases that file will just have a singular "#include
#   <stdint.h>" or "#include <inttypes.h>" statement, while in other
#   environments it will provide the set of basic 'stdint's defined:
...
#   definitions of other files, or using the AC_COMPILE_CHECK_SIZEOF macro
#   to determine the actual sizeof each type.
#
