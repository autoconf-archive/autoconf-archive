...
#   'rootpass' and a 'SELECT * FROM user' SQL statement. That SQL
#   statement will select all user information from the 'user'
#   privileges table, and should work on every proper MySQL server.
#
#   Besides checking mysql, this macro also set these environment
