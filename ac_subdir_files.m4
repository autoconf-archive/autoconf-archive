...
# DESCRIPTION
#
#   Look into subdirs and copy the (real) files that match pattern into
#   the local directory. Preferably we use a symbolic link of course.
#   existing local files are not overwritten.
#
#   The default casepattern is "*.?|*.cc|*.cpp", the default
#   subdir-list contains all subdirs available.
#
# LAST MODIFICATION
#
#   2007-02-14
