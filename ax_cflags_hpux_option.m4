...
# DESCRIPTION
#
#   AX_CFLAGS_HPUX_OPTION(-Afresh) would show a message as like
#   "checking CFLAGS for hpux/cc -Afresh ... yes" and adds the
...
#
#   The cousin AX_CXXFLAGS_HPUX_OPTION would check for an option to add
