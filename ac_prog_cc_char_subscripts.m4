...
# DESCRIPTION
#
#   Try to find a compiler option that enables usage of char-type to
#   index a value-field. This one needs unsigned-chars and it must
#   suppress warnings about usage of chars for subscripting. for gcc
#   -funsigned-char -Wno-char-subscripts
#
