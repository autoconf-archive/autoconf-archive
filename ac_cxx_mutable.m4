...
# DESCRIPTION
#
#   If the compiler allows modifying class data members flagged with
#   the mutable keyword even in const objects (for example in the body
#   of a const member function), define HAVE_MUTABLE.
#
# LAST MODIFICATION
#
#   2004-02-04
